        ...
        <div>
            ...
            <section className="relative h-[500px] bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/1920/1080?grayscale&blur=2&random=10')" }}>
                ...
                <div className="relative h-full flex flex-col justify-center items-center text-center text-white z-10 px-4">
                    <h1 className="text-5xl md:text-6xl font-extrabold mb-4 leading-tight">Competitive Advantages For The Largest Companies!</h1>
                    <p className="text-xl md:text-2xl font-light">Safe, Reliable & Express Logistic Solutions That Saves Your Time</p>
                </div>
            </section>
             ...
             <section className="py-20 bg-white">
                <div className="container mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
                    <div>
                        <img src="https://picsum.photos/600/400?random=11" alt="Warehouse Professional" className="rounded-lg shadow-2xl"/>
                    </div>
                    <div>
