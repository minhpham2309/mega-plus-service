        ...
        <div className="overflow-x-hidden">
            ...
            <section className="relative py-16 md:py-24 bg-cover bg-center" style={{ backgroundImage: "url('https://picsum.photos/1920/1080?grayscale&blur=2&random=99')" }}>
                ...
                <div className="relative container mx-auto px-4 md:px-6 text-center text-white z-10">
                    <h1 className="text-3xl md:text-5xl font-normal mb-6 md:mb-8 uppercase tracking-wider">{t('about.banner_title')}</h1>
            ...
            <section className="py-12 md:py-20 bg-white dark:bg-gray-900 transition-colors duration-300">
                <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <AnimatedSection delay={200}>
                        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-4">{t('about.vision_title')}</h2>
                        <p className="text-sm md:text-base text-gray-600 dark:text-gray-300 mb-6 leading-relaxed text-justify md:text-left">
                            {t('about.vision_desc')}
                        </p>
                        
                        <h3 className="text-lg md:text-xl font-bold text-gray-800 dark:text-white mb-3">{t('about.mission_title')}</h3>
            ...
            <section className="py-12 md:py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
                <div className="container mx-auto px-4 md:px-6 grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    <AnimatedSection delay={200}>
                        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white mb-6">{t('about.core_value_title')}</h2>
